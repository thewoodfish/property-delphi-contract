...
- `PropertyType`:
  ...
  This represents the type of a property. There are many separate information that are important to various districts and states that is defined by a document schema. This scheme, specific to a region is the property type.
